 ...
 * @author amanda
 */
public class IncomeTransaction extends javax.swing.JFrame {

    /**
     * Creates new form IncomeTransaction
     */
    ...
    private void initComponents() {
        ...
        jPanel12.setBackground(new java.awt.Color(235, 236, 236));
        ...
        jLabel40.setText("Transaksi Pemasukan");

        jLabel14.setFont(new java.awt.Font("Ubuntu", 2, 15)); // NOI18N
        jLabel14.setText("Input Transaksi Pemasukan");
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel16Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tfNamaKaryawan, javax.swing.GroupLayout.PREFERRED_SIZE, 364, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel16Layout.setVerticalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel16Layout.createSequentialGroup()
                        .addGap(33, 33, 33)
                        .addComponent(dPickerTransaksi, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel16Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
        ...
        jLabel16.setText("Daftar Transaksi Pemasukan");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        java.sql.Date tgl_nota = new java.sql.Date(selectedDate.getTime());   
         ...
         try {
            String sql = "INSERT INTO transaksi_pemasukan (id, nama_karyawan, nominal, partner, keterangan, tgl_dibuat) VALUES "
                                        + "('"+tfId.getText()
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            String sql = "UPDATE transaksi_pemasukan SET id = '"+tfId.getText()
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        try {
            String sql ="delete from transaksi_pemasukan where id='"+tfId.getText()+"'";
            java.sql.Connection conn = Connection.configDB();
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            pst.execute();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IncomeTransaction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadData(){ 
        ...
        try { 
            String sql = "select * from transaksi_pemasukan";
